...
def user_recomm(user_id,  genres_list, concatenated_tags_list, data, model, k=10):
...
def init():
    ...
    return genres_list, concatenated_tags_list, data, model


# if __name__ == "__main__":
# this code run only one time at the first start


genres_list, concatenated_tags_list, data, model = init()
# this code run each time for every new recommendation
user_id = 5
k = 30
# user_recomm(user_id, genres_list, concatenated_tags_list, data, model, k)
